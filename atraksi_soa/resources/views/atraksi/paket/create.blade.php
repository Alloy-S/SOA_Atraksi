...
@section('container')
    ...
    <form action="/atraksi/{{ $atraksi->slug }}/paket" method="post" class="col-lg-8 mb-5">
        ...
        <div class="mb-3">
            ...
            @enderror
            <input id="fasilitas" type="hidden" name="fasilitas" id="fasilitas" value="{{ old('fasilitas') }}">
        ...
        <div class="mb-3">
            ...
            <input id="syarat_dan_ketentuan" type="hidden" name="syarat_dan_ketentuan" id="syarat_dan_ketentuan"
                value="{{ old('syarat_dan_ketentuan') }}">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('harga_discount') is-invalid @enderror" id="harga_discount"
                name="harga_discount" required autofocus value="{{ old('harga_discount') }}">
