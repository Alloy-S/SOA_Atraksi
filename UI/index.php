...
<body>
    ...
    <!-- modal paket 1 -->
    <div class="modal fade" id="paket-modal-1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="paketLabel-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div id="deskripsi-paket-1" class="btn-modal-paket py-3 fw-semibold d-flex justify-content-between" data-bs-toggle="collapse" href="#deskripsi-collapse-1" role="button" aria-expanded="false" aria-controls="deskripsi-collapse-1">
                        <!-- <span>Deskripsi</span> -->
                        <p>Deskripsi</p>
                        <span>></span>
                    </div>
                    <div class="collapse" id="deskripsi-collapse-1">
                        <p>Tiket Dunia Fantasi (Dufan) Ancol - (High Season) Six Months Pass Dufan (Ecard) - belum termasuk tiket Ancol</p>
                    </div>

                    <div id="caraPenukaran-paket-1" class="btn-modal-paket py-3 fw-semibold d-flex justify-content-between" data-bs-toggle="collapse" href="#caraPenukaran-collapse-1" role="button" aria-expanded="false" aria-controls="caraPenukaran-collapse-1">
                        <!-- <span>Deskripsi</span> -->
                        <p>
                            Cara Penukaran
                        </p>
                    ...
                    <div class="collapse" id="caraPenukaran-collapse-1">
                        <p>Bawa dan tunjukkan e-tiket dari tiket.com (boleh dicetak atau cukup dari smartphone saja) ke staf yang bertugas di loket penukaran tiket untuk ditukarkan menjadi tiket asli.</p>
                    </div>

                    <div id="fasilitas-paket-1" class="btn-modal-paket py-3 fw-semibold d-flex justify-content-between" data-bs-toggle="collapse" href="#fasilitas-collapse-1" role="button" aria-expanded="false" aria-controls="fasilitas-collapse-1">
                        <!-- <span>Deskripsi</span> -->
                        <p>
                            Fasilitas
                        </p>
                    ...
                    <div class="collapse" id="fasilitas-collapse-1">
                        <ul class="">
                            <li class="">Kamar Mandi</li>
                            <li class="">Free Wifi</li>
                            <li class="">Parkir</li>
                        </ul>
                    </div>

                    <div id="syarat-paket-1" class="btn-modal-paket py-3 fw-semibold d-flex justify-content-between" data-bs-toggle="collapse" href="#syarat-collapse-1" role="button" aria-expanded="false" aria-controls="syarat-collapse-1">
                        <!-- <span>Deskripsi</span> -->
                        <p>
                    ...
                    <div class="collapse" id="syarat-collapse-1">
                        <ul class="">
                            <li class="">Kamar Mandi</li>
                            <li class="">Free Wifi</li>
                            <li class="">Parkir</li>
    ...
    <!-- modal paket 2 -->
    <div class="modal fade" id="paket-modal-2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="paketLabel-2" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Detail Paket</h1>
                ...
                <div class="modal-body">
                    <div id="deskripsi-paket-2" class="btn-modal-paket py-3 fw-semibold d-flex justify-content-between" data-bs-toggle="collapse" href="#deskripsi-collapse-2" role="button" aria-expanded="false" aria-controls="deskripsi-collapse-2">
                        <!-- <span>Deskripsi</span> -->
                        <p>Deskripsi</p>
                        <span>></span>
                    </div>
                    <div class="collapse" id="deskripsi-collapse-2">
                        <p>Tiket Dunia Fantasi (Dufan) Ancol - (High Season) Six Months Pass Dufan (Ecard) - belum termasuk tiket Ancol</p>
                    </div>

                    <div id="caraPenukaran-paket-2" class="btn-modal-paket py-3 fw-semibold d-flex justify-content-between" data-bs-toggle="collapse" href="#caraPenukaran-collapse-2" role="button" aria-expanded="false" aria-controls="caraPenukaran-collapse-2">
                        <!-- <span>Deskripsi</span> -->
                        <p>
                            Cara Penukaran
                        </p>
                    ...
                    <div class="collapse" id="caraPenukaran-collapse-2">
                        <p>Bawa dan tunjukkan e-tiket dari tiket.com (boleh dicetak atau cukup dari smartphone saja) ke staf yang bertugas di loket penukaran tiket untuk ditukarkan menjadi tiket asli.</p>
                    </div>

                    <div id="fasilitas-paket-2" class="btn-modal-paket py-3 fw-semibold d-flex justify-content-between" data-bs-toggle="collapse" href="#fasilitas-collapse-2" role="button" aria-expanded="false" aria-controls="fasilitas-collapse-2">
                        <!-- <span>Deskripsi</span> -->
                        <p>
                            Fasilitas
                        </p>
                    ...
                    <div class="collapse" id="fasilitas-collapse-2">
                        <ul class="">
                            <li class="">Kamar Mandi</li>
                            <li class="">Free Wifi</li>
                            <li class="">Parkir</li>
                    ...
                    <div id="syarat-paket-2" class="btn-modal-paket py-3 fw-semibold d-flex justify-content-between" data-bs-toggle="collapse" href="#syarat-collapse-2" role="button" aria-expanded="false" aria-controls="syarat-collapse-2">
                        <!-- <span>Deskripsi</span> -->
                        <p>
                            Syarat dan Ketentuan
                        </p>
                    ...
                    <div class="collapse" id="syarat-collapse-2">
                        <ul class="">
                            <li class="">Kamar Mandi</li>
                            <li class="">Free Wifi</li>
                            <li class="">Parkir</li>
